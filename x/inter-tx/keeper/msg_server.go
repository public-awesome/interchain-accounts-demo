...
func (k msgServer) SubmitTx(goCtx context.Context, msg *types.MsgSubmitTx) (*types.MsgSubmitTxResponse, error) {
	...
	channelID, found := k.controllerKeeper.GetActiveChannelID(ctx, msg.ConnectionId, portID)
	if !found {
	...
	_, err = k.controllerKeeper.SendTx(ctx, chanCap, msg.ConnectionId, portID, packetData, uint64(timeoutTimestamp))
	if err != nil {
		return nil, err
	}
